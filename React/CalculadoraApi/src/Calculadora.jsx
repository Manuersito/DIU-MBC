    ...
    <div className="App">
      ...
      <div className="container-fluid p-3">
        ...
        <div className="row">
          ...
          <div className="col-3 mb-2">
            <button className="operator w-100" onClick={handleSignChange}>+/-</button>
          </div>
          <div className="col-3 mb-2">
            <button className="operator w-100" onClick={() => handleInput("%")}>%</button>
          </div>
          <div className="col-3 mb-2">
            <button className="operator w-100" onClick={() => handleInput("/")}>÷</button>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-3 mb-2">
            <button className="operator w-100" onClick={handleCalculate}>=</button>
          </div>
        </div>
      </div>
    </div>
