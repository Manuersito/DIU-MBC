...
public class Acordeon extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image logo1 = new Image("file:resources/imagenes/calamardo.jpeg", 100, 100, true, true);
            Image logo2 = new Image("file:resources/imagenes/gato.jpeg", 100, 100, true, true);
