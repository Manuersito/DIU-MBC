...
public class InformacionContextual extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imgCerveza = new Image("file:Resources/imagenes/cerveza.png", 100, 100, true, true);
            ...
            Image imgApagar = new Image("file:Resources/imagenes/botonapagar.jpg", 100, 100, true, true);            infoCerveza.setGraphic(new ImageView(imgApagar));
