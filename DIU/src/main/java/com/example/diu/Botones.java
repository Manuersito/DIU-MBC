...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagen = new Image("file:Resources/imagenes/cerveza.png", 30, 30, true, true);
            ...
            Image imagen2 = new Image("file:Resources/imagenes/botonapagar.jpg", 20, 20, true, true);
